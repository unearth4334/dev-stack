...
This is the original broad roadmap, preserved as design history. The [Pilot v0.1 plan](pilot/index.html) supersedes its phase ordering for current delivery and defers several platform features. Do not use the phases below as the live milestone inventory.
