...
The follow-up tracking PR records its own CI/review evidence and publishes the actual milestone/issue links. Automatic Copilot review is enabled for main-branch PRs and new pushes (repository ruleset 22882825); missing requests were also made explicitly during plan review.
